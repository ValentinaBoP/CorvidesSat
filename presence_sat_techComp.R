#!/usr/bin/env Rscript
# Usage: Rscript --vanilla presence_sat_techComp.R list_sats GenomeSize_summary.txt figure_name
...
# order species
levels = rev(c("lycPyr_reads", "lycPyr_10X", "lycPyr_PB_reads", "lycPyr_PB", "ptiInt_reads", "ptiInt_10X", "ptiInt_PB_reads", "ptiInt_PB"))
